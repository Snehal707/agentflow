...
const SLUG_CONFIG: Record<string, SlugConfig> = {
  ...
  predmarket: { envUrl: 'PREDMARKET_AGENT_URL', envPort: 'PREDMARKET_AGENT_PORT', defaultPort: 3013 },
  bridge: { envUrl: 'BRIDGE_AGENT_URL', envPort: 'BRIDGE_AGENT_PORT', defaultPort: 3021 },

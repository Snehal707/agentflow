...
/// @notice ERC-4626 vault over USDC. APY is set by owner for reference; yield via `compound`.
contract AgentFlowVault is ERC4626, Ownable {
    ...
    /// @notice Owner pulls USDC from their balance into the vault (increases assets per share).
